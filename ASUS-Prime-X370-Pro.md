...
My [ASUS Maximus IV Gene-Z](ASUS-Maximus-IV-Gene-Z.md) system was repurposed for pure file server purposes (FreeNAS) so I moved my kids' VM to my gaming rig. I also needed another gaming rig so that 2.0 and 3.0 can play Minecraft with me.
...
2. Enable virtualization in the BIOS: IOMMU in the AMD CBS sub menu and SVM in the CPU sub menu.
